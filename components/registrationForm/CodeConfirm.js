...
const CodeMask = (props) => <InputMask mask="9999" maskPlaceholder={null} className="my-input" {...props} />;
        ...
        return (
            ...
            <div class="alert alert-success mx-auto" role="alert">
                ...
                {/* <div className="form-group">
                    ...
                    <InputMask   id='code' name='code'  mask="9999" placeholder='____' class="form-control" maskPlaceholder=" "   onChange={this.handleChange}
