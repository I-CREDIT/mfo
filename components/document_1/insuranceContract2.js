    ...
    content: [
      ...
      },
      {
        stack: [
          ...
          {
            text: 'ПОЛИС ДОБРОВОЛЬНОГО ОНЛАЙН СТРАХОВАНИЯ ЖИЗНИ',
            fontSize: 8,
            bold: true,
            alignment: 'center'
          },
          {
            text: `СЕРИЯ № ${props.contractNumber}`,
            fontSize: 8,
            bold: true,
            alignment: 'center'
          }
        ...
        table: {
          ...
          body: [
            ...
            [
              ...
              },
              {
                stack: [
                  ...
                  {
                    text: '1) Мужчины, достигшие 67 (шестьдесят семь) лет и женщины, достигшие 70 (семидесят) лет на дату заключения страхового полиса;',
                    fontSize: 7.5,
                    alignment: 'justify'
                  },
                  {
            ...
            [
              ...
              {
                text: 'Сақтандыру ережелерінің 16 бабына сәйкес/Согласно статьи 16 Правил страхования',
                fontSize: 7.5,
                alignment: 'justify'
              }
            ],
            ...
            [
              {
                ...
                stack: [
                  ...
                  {
                    text: '27 шілде 2020. Компанияның Директорлар Кеңесімен бекітілген өмірді ерікті онлайн түрде сақтандыру ережелері Сақтандырушының әріптесінің www.i-credit.kz интернет-ресурсында орналастырылған/ Правила добровольного онлайн страхования жизни, утвержденных Советом Директоров 27 июля 2020 года, размещены на интернет-ресурсе  Партнера Страховщика www.i-credit.kz',
                    fontSize: 7.5,
                    alignment: 'justify',
                  },
                  {
                    text: 'Настоящим Страхователь/Застрахованный подтверждает, что ознакомлен и согласен, что настоящий страховой полис подтверждает присоединение к Правилам добровольного онлайн страхования жизни, утвержденных Советом Директоров 27 июля 2020 года.',
                    fontSize: 7.5,
                    alignment: 'justify',
                  },
                  {
      ...
      },
      {
        stack: [
          {
            text: `Приложение № 1 к страховому полису №${props.contractNumber} от ${props.givenDate}`,
            fontSize: 7.5,
            alignment: 'right'
          },
          {
            text: `${props.givenDate} жылғы №${props.contractNumber} сақтандыру полиске № 1 Қосымша`,
            fontSize: 7.5,
            alignment: 'right'
          }
        ]
            ...
            [
              {
                stack: [
                  {
                    text: 'Тараптардың негізгі құқықтары мен міндеттерінің сипаттамасы',
                    fontSize: 7.5,
                    justify: 'justify',
                    bold: true
                  },
                  {
                    text: '1.Сақтанушының құқығы бар:',
                    fontSize: 7.5,
                    justify: 'justify',
                  },
                  {
                    text: '1) сақтандыру келісімшартын уақытынан бұрын бұзуға;',
                    fontSize: 7.5,
                    justify: 'justify',
                  },
                  {
                    text: '2) Сақтандырушыдан сақтандыру келісімшартындағы міндеттерді орындауын талап етуге;',
                    fontSize: 7.5,
                    justify: 'justify',
                  },
                  {
                    text: '3) Сақтандырушыдан сақтандыру келісімшартына сәйкес сақтандыру шарттарын, өз құқықтарын және міндеттерін анықтап алуға;',
                    fontSize: 7.5,
                    justify: 'justify',
                  },
                  {
                    text: '4) Сақтандыру ережелерде қарастырылған сақтандыру төлемін сақтандыру жағдайы орын алған сәтте алуға;',
                    fontSize: 7.5,
                    justify: 'justify',
                  },
                  {
                    text: '2.Сақтанушы міндетті:',
                    fontSize: 7.5,
                    justify: 'justify',
                  },
                  {
                    text: '1) сақтандыру сыйақысын сақтандыру келісімшартында орындалған ереже мен мерзімде, көлемде төлеп отыруға;',
                    fontSize: 7.5,
                    justify: 'justify',
                  },
                  {
                    text: '2) сақтандыру тәуекелі туралы жағдайды Сақтандырушыға хабарлап отыруға;',
                    fontSize: 7.5,
                    justify: 'justify',
                  },
                  {
                    text: '3) сақтандыру келісімшартында орныққан сақтандыру мерзімі жақындағандығы туралы Сақтандырушыға ескертіп отыруға;',
                    fontSize: 7.5,
                    justify: 'justify',
                  },
                  {
                    text: '4) егер Сақтанушы Сақтандырылмаған болса, онда Сақтандырушыға сақтандыру келісімшарты негізінде жазылған жазбаша келісімді ұсынуға;',
                    fontSize: 7.5,
                    justify: 'justify',
                  },
                  {
                    text: '5) Сақтандырушыға қарыз келісімшартының көшірмесін ұсынуы керек.',
                    fontSize: 7.5,
                    justify: 'justify',
                  },
                  {
                    text: '3.Сақтандырушы құқығы бар:',
                    fontSize: 7.5,
                    justify: 'justify',
                  },
                  {
                  ...
                  {
                    text: '2) Сақтанушыдан сақтандыру келісімшартына сәйкес орындауға міндеттейтін жауапкершілікті талап етуге;',
                    fontSize: 7.5,
                    justify: 'justify',
                  },
                  {
                    text: '3) қарыз келісімшартына қатысты Пайда көрушіден ақпарат алуға құқығы бар.',
                    fontSize: 7.5,
                    justify: 'justify',
                  },
                  {
                    text: '4. Сақтандырушы міндетті:',
                    fontSize: 7.5,
                    justify: 'justify',
                  },
                  {
                    text: '1) сақтандыру жағдайы орын алған жағдайда сақтандыру келісімшартында көрсетілген көлемде, мерзім мен ережеде сақтандыру төлемін жүргізуге;',
                    fontSize: 7.5,
                    justify: 'justify',
                  },
                  {
                    text: '2) сақтандыру құпиясын қамтамасыз етуге;',
                    fontSize: 7.5,
                    justify: 'justify',
                  },
                  {
                    text: '3) Сақтанушыны сақтандыру Ережесімен таныстыруға және сақтандыру Ережесінің көшірмесін сұраным негізінде ұсынуға (бағыттауға);',
                    fontSize: 7.5,
                    justify: 'justify',
                  },
                  {
                    text: '4) сақтандыру Ережесінің 14 бабы, 5 тармағына сәйкес орнатылған Сақтандыру төлемін жүргізуге қажетті Сақтанушы (Сақтандырылған, Пайда көруші) не болмаса оның құжат бойынша құжаттарды ұсынатын өкілеті ұсынбаса, құжаттардың түгел емес екендігі туралы ескертуі керек.',
                    fontSize: 7.5,
                    justify: 'justify',
                  },
                  {
                    text: '5. Сақтандыру ереже бабының 4 тармағы 3) тармақшасында көрсетілгендей Сақтандырушының міндетіне Ережелерді бағыттау Сақтанушының электронды мекенжай поштасына немесе Сақтандырушының интернет-ресурсында орналастыру кіреді.',
                    fontSize: 7.5,
                    justify: 'justify',
                  },
                  {
                    text: '6.Сақтанушы және Сақтандырушы ҚР заңнамасы мен сақтандыру келісімшартындағы Ережеден бөлек және (немесе) қарастырылған басқа да құқыққа және басқа да міндеттерге ие.',
                    fontSize: 7.5,
                    justify: 'justify',
                  },
                ]
              },
              {
                stack: [
                  {
                    text: 'Описание основных прав и обязанностей сторон',
                    fontSize: 7.5,
                    justify: 'justify',
                    bold: true
                  },
                  {
                    text: '1. Страхователь имеет право:',
                    fontSize: 7.5,
                    justify: 'justify',
                  },
                  {
                    text: '1) досрочно расторгнуть договор страхования;',
                    fontSize: 7.5,
                    justify: 'justify',
                  },
                  {
                    text: '2) требовать от Страховщика исполнения принятых в соответствии с договором страхования обязательств;',
                    fontSize: 7.5,
                    justify: 'justify',
                  },
                  {
                    text: '3) требовать от Страховщика разъяснений условий страхования, своих прав и обязанностей по договору страхования;',
                    fontSize: 7.5,
                    justify: 'justify',
                  },
                  {
                    text: '4) получить страховую выплату в случаях, предусмотренных Правилами страхования.',
                    fontSize: 7.5,
                    justify: 'justify',
                  },
                  {
                    text: '2. Страхователь обязан:',
                    fontSize: 7.5,
                    justify: 'justify',
                  },
                  {
                    text: '1) уплачивать страховую премию в размере, порядке и сроки, установленные договором страхования;',
                    fontSize: 7.5,
                    justify: 'justify',
                  },
                  {
                    text: '2) информировать Страховщика о состоянии страхового риска;',
                    fontSize: 7.5,
                    justify: 'justify',
                  },
                  {
                    text: '3) уведомить Страховщика о наступлении страхового случая в сроки, установленные договором страхования;',
                    fontSize: 7.5,
                    justify: 'justify',
                  },
                  {
                    text: '4) предоставить Страховщику копию договора займа.',
                    fontSize: 7.5,
                    justify: 'justify',
                  },
                  {
                    text: '3.Страховщик вправе:',
                    fontSize: 7.5,
                    justify: 'justify',
                  },
                  {
                  ...
                  {
                    text: '2) требовать от Страхователя исполнения принятых в соответствии с договором страхования обязательств;',
                    fontSize: 7.5,
                    justify: 'justify',
                  },
                  {
                    text: '3) запрашивать у Выгодоприобретателя информацию, относящуюся к договору займа.',
                    fontSize: 7.5,
                    justify: 'justify',
                  },
                  {
                    text: '4. Страховщик обязан:',
                    fontSize: 7.5,
                    justify: 'justify',
                  },
                  {
                    text: '1) при наступлении страхового случая произвести страховую выплату в размере, порядке и сроки, установленные договором страхования;',
                    fontSize: 7.5,
                    justify: 'justify',
                  },
                  {
                    text: '2) обеспечить тайну страхования;',
                    fontSize: 7.5,
                    justify: 'justify',
                  },
                  {
                    text: '3) ознакомить Страхователя с Правилами страхования и предоставить (направить) по его требованию копию Правил страхования;',
                    fontSize: 7.5,
                    justify: 'justify',
                  },
                  {
                    text: '4) в случаях непредставления Страхователем (Застрахованным, Выгодоприобретателем) либо его представителем документов, необходимых для осуществления страховой выплаты, уведомить их о недостающих документах в срок, установленный пунктом 5 статьи 14 Правил страхования.',
                    fontSize: 7.5,
                    justify: 'justify',
                  },
                  {
                    text: '5.Направление Правил страхования по указанному Страхователем адресу электронной почты или их размещение на интернет-ресурсе Страховщика является надлежащим исполнением обязанности Страховщика, указанной в подпункте 3) пункта 4 настоящей статьи Правил.',
                    fontSize: 7.5,
                    justify: 'justify',
                  },
                  {
                    text: '6. Страхователь и Страховщик имеют иные права и несут иные обязанности, предусмотренные и (или) вытекающие из Правил, договора страхования и законодательства РК.',
                    fontSize: 7.5,
                    justify: 'justify',
                  },
                ]
      ...
      },
      {
        stack: [
          ...
          {
            text: 'Өмірді ерікті онлайн түрде сақтандыруға өтініш/ Заявление на добровольное онлайн страхование жизни',
            fontSize: 8,
            bold: true,
            alignment: 'center'
          },
        ...
        table: {
          ...
          body: [
                ...
                stack: [
                  {
                    text: [
                      ...
                      'Пайда алушы/Выгодоприобретатель'],
                    fontSize: 8, 
                  },
                  {
                    text: [
                ...
                stack: [
                  {
                    text: [
                      ...
                      'Өмірді ерікті онлайн түрде сақтандыру/Добровольное онлайн страхование жизни'],
                    fontSize: 8, 
                  },
                ]
              }
            ...
            [
              {
                colSpan: 2,
                text: 'Сұратылған сақтандыру сомасы/Запрашиваемая страховая сумма: равна сумме основного долга по договору займа, заключенному между страхователем и ТОО «Микрофинансовая организация «i-credit.kz», указывается в страховом полисе/ Сақтанушының және «i-credit.kz» «Микроқаржы ұйымы» ЖШС арасында жасалған  кредит беру туралы шарт бойынша негізгі қарызға тең және сақтандыру  полисте көрсетілген.',
                fontSize: 8
              }
            ]
          ]
            ...
            [
              ...
              },
              {
                stack: [
                  ...
                  {
                    text: 'Я ознакомлен и согласен с Правилами добровольного онлайн страхования жизни от несчастного случая, утверждённых Советом Директоров 17 июля 2020 года, копию указанных Правил страхования получил.',
                    fontSize: 7,
                    alignment: 'justify'
                  },
                  {
