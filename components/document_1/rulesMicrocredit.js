...
const RulesMicrocreditDocument = (props) => {
  let RulesMicrocredit = {
    content: [
      ...
      {
        text: '1. За нарушение обязательства по возврату суммы микрокредита и (или) уплате вознаграждения по Договору, МФО вправе требовать от Заемщика уплаты суммы неустойки (пени) в размере 0,5% от суммы неисполненного обязательства за каждый день просрочки.',
        fontSize: 12,
        alignment: 'justify'
      },
      {
        text: '2. При наличии у Заемщика просроченных платежей по Микрокредиту, МФО осуществляет работу по возврату задолженности, путем:',
        fontSize: 12,
        alignment: 'justify'
      },
      {
      ...
      {
        text: '3. МФО вправе производить уступку права (требования) следующим лицам:',
        fontSize: 12,
        alignment: 'justify'
      },
      {
      ...
      {
        text: '4. В случае неисполнения Заемщиком обязательств, срок исполнения по которым наступил, МФО/Взыскатель обращается к нотариусу за совершением исполнительной надписи по своему выбору:',
        fontSize: 12,
        alignment: 'justify'
      },
      {
      ...
      {
        text: '5. Условия и порядок урегулирования задолженности и меры, применяемые в отношении неплатежеспособного клиента, устанавливаются Законом.',
        fontSize: 12,
        alignment: 'justify'
      },
      {
      ...
      {
        text: '1. Подключая сервис «Автоплатеж», Заемщик соглашается на автоматическое списание денежные средств в счет оплаты сумм по Договору о предоставлении микрокредита, заключенного с МФО в течение всего срока действия Договора до момента отказа от использования сервиса «Автоплатеж» в соответствии в соответствии с п.10 настоящей главы.',
        fontSize: 12,
        alignment: 'justify'
      },
      {
        text: '2. Активируя Услугу «Автоплатежи», Заемщик подтверждает свое согласие на периодическое списание денежных средств со счета Банковской карты и/или Денежных средств, на сумму, определяемую МФО исходя из графика погашения, начиная с момента активации Услуги «Автоплатежи» до момента деактивации услуги.',
        fontSize: 12,
        alignment: 'justify'
      },
      {
        text: '3. Акцептом и заказом Услуги «Автоплатежи» является последовательная совокупность действий Заемщика на интернет ресурсе МФО, Активация (подключение) Услуги «Автоплатежи» предполагает выполнение следующих действий Заемщиком:',
        fontSize: 12,
        alignment: 'justify'
      },
      {
        text: 'При использовании интернет ресурса, перед отправкой данных Банковской карты, Заемщик подключается к Услуге «Автоплатежи» путем установки соответствующего флажка напротив ссылки на Согласие на подключение автоплатежей при нажатии на которую, будет открыта отдельная страница, где Заемщику будет показано Заявление о присоединении к услуге «Автоплатежи», которое Клиентом подписывается после введения своего ИИН, путем ввода направленного МФО одноразового (единовременного) кода. Услуга «Автоплатежи» подключается только для Банковской карты, зарегистрированной Держателем карты.',
        fontSize: 12,
        alignment: 'justify'
      },
      {
        text: 'Регистрация Банковской карты происходит при совершении Держателем карты подключения к Услуге, путем указания на соответствующей веб-странице платежных данных Банковской карты. Заемщик (Держатель карты) гарантирует, что он осознанно, корректно и полностью вводит все требуемые реквизиты Банковской карты при активации (подключении) Услуги «Автоплатежи».',
        fontSize: 12,
        alignment: 'justify'
      },
      {
        text: '4. Срок акцепта условий Соглашения неограничен и действует до момента отказа от использования сервиса «Автоплатеж» в соответствии с п.10 настоящей главы.',
        fontSize: 12,
        alignment: 'justify'
      },
      {
        text: '5. После подключения Услуги «Автоплатежи» с Банковской карты Заемщика будут осуществляться Автоплатежи, списание в сроки и размерах, определенных графиком погашения и необходимых для надлежащего исполнения обязанности Заемщиком по оплате микрокредитов.',
        fontSize: 12,
        alignment: 'justify'
      },
      {
        text: '6. В случае недостаточности денежных средств на счете Банковской карты для осуществления очередного платежа МФО/Партнер платежной системы имеет право повторять запрос на списание с Банковской карты денежных средств и/или Денежных средств.',
        fontSize: 12,
        alignment: 'justify'
      },
      {
        text: '7. Пользование Услугой «Автоплатежи» возможно по незаблокированным Банковским картам при условии достаточности средств на Банковской карте. В случае окончания срока действия Банковской карты, предоставление услуги будет приостановлено до момента регистрации новой Банковской карты.',
        fontSize: 12,
        alignment: 'justify'
      },
      {
        text: '8. Услуга Автоплатеж проводится по микрокредиту в дату планового платежа. При этом, МФО/Партнер платежной системы информирует Заемщика о предстоящем списании за 7 дней до списания платы путем отправки СМС-сообщения либо электронного сообщения на электронную почту Заемщика.',
        fontSize: 12,
        alignment: 'justify'
      },
      {
        text: '9. Заемщик может добавить одну основную карту и две дополнительные карты, по которым будет проводиться списания по Услуге в случае, если провести списание по основной карте невозможно.',
        fontSize: 12,
        alignment: 'justify'
      },
      {
        text: '10. Заемщик вправе отменить платеж за сутки до списания.',
        fontSize: 12,
        alignment: 'justify'
      },
      {
        text: 'Отключение (отказ) Заемщика от Услуги «Автоплатежи» происходит:',
        fontSize: 12,
        alignment: 'justify'
      },
      {
        text: 'В «Личном кабинете» Заемщик выбирает раздел «Автоплатеж».',
        fontSize: 12,
        alignment: 'justify'
      },
      {
        text: 'Нажимает кнопку «Отключить/ Удалить карту».',
        fontSize: 12,
        alignment: 'justify'
      },
      {
        text: 'При этом денежные средства, переведенные с Банковской карты до отключения (отказа) Заемщика от Услуги «Автоплатежи», Заемщику не возвращаются.',
        fontSize: 12,
        alignment: 'justify'
      },
      {
        text: 'Нажимает на кнопку «Продолжить».',
        fontSize: 12,
        alignment: 'justify'
      },
      {
        text: 'Вводит полученный код и подтверждает действие с помощью кнопки.',
        fontSize: 12,
        alignment: 'justify'
      },
      {
        text: 'Операцию там же можно «Приостановить», если планируется ее возобновление.',
        fontSize: 12,
        alignment: 'justify'
      },
      {
