    ...
    content: [
      ...
      },
      {
        stack: [
          ...
          {
            text: '27 шілде 2020. Компанияның Директорлар Кеңесімен бекітілген Қарыз алушының өмірін ерікті онлайн түрде сақтандыру ережелері Сақтандырушының әріптесінің www.i-credit.kz интернет-ресурсында орналастырылған/ Правила добровольного онлайн страхования жизни заёмщика, утвержденных Советом Директоров 27 июля 2020 года, размещены на интернет-ресурсе Партнера Страховщика www.i-credit.kz',
            fontSize: 7.5,
            alignment: 'justify',
          },
          {
