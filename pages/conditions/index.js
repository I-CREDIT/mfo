            ...
            <div className="condition row">
              ...
              <div className="condition--info col-md-5">
                <p>Льготный период под 0% до 7 дней. Максимальная ставка вознаграждения с 8го дня 1% в день,
                  годовая ставка вознаграждения - 360%. Срок микрокредита – до 90 дней.</p>
                <p>Льготный период под 0% до 7 дней. Максимальная ставка вознаграждения с 8го дня 1% в день. Срок займа – до 45 дней.</p>
              </div>
            </div>
          </section>
          <section className="conditions">
            <div className="condition row">
              ...
              <div className="condition--info col-md-5">
                <p>В случае нарушения установленного срока платежа по микрокредиту, заемщик будет обязан оплатить
