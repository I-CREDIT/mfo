          ...
          <div className="mapping row">
            <div className="col-md-5 col-lg-4 mapping--text">
              ...
              <span>Call center:</span>
                ...
                <br></br>
                <span>Отдел взыскания:</span>
                <a href="tel: +77788701029"><i className="fa fa-phone" />+7 778 870 10 29</a>
                <br></br>
                <span>Электронная почта:</span>
                <a href="mailto: info@i-credit.kz"><i className="fa fa-box" />info@i-credit.kz</a>
              </div>
            </div>
