    ...
    return (
      <div>
        ...
        <div className="view">
          <div className="container">
            <ul className="mainphone-numbers phone-numbers">
              <li className="phonenotworking">
                <span>Call center:</span>
                <h1>
                  <i className="fa fa-phone" />
                  <a href="tel:+77007501500">
                    +7 700 <b className="black">750 15 00</b>
                  </a>
                </h1>
                <b className="phoneInfo"></b>
              </li>
              <li>
                <span>{t("collection-department")}</span>
                <i className="fa fa-phone" />
                <h1>
                  <a href="tel:+77788701029">
                    +7 778 <b className="black">870 10 29</b>
                  </a>
                </h1>
              </li>
            </ul>
            <div
              ...
              styles={{ backgroundImage: `url(${banner})` }}
            >
                ...
                {i18n.language === "ru" ? (
                  <h1 className="secondary-header col-md-4 col-12">
                    ...
                    <span className="d-block">
                      {t("header-text-3")}{" "}
                      <span className="red">{t("header-text-red")}</span>
                    </span>
                  </h1>
                ) : (
                  <h1 className="secondary-header col-md-4 col-12">
        ...
        <main className="container">
          <section className="finance">
            ...
            <div className="advantages text-center">
              <div className="advantages--box">
                <div>
                  <h1>
                    <span className="red d-block">1</span>
                    {t("fast")}
                  </h1>
                  <p>{t("fast-content")}</p>
                </div>
              ...
              <div className="advantages--box">
                <div>
                  <h1>
                    <span className="red d-block">2</span>
                    {t("conveniently")}
                  </h1>
              ...
              <div className="advantages--box">
                <div>
                  <h1>
                    <span className="red d-block">3</span>
                    {t("available")}
                  </h1>
              ...
              <div className="row presentblock">
                <div className="col-md-6 present">
                  ...
                  <AppLink href="/get_money">
                    <div className="content-bottom red">{t("get-money")}</div>
                  </AppLink>
          ...
          <section className="stepmoney">
            ...
            <div className="steps mt-5">
              <div className="row">
                <div className="step mb-5 col-md-6">
                  <img
                    src={require("../img/svg/icon 1.svg")}
                    className="mb-5"
                  />
                ...
                <div className="step mb-5 col-md-6">
                  <img
                    src={require("../img/svg/icon 2.svg")}
                    className="mb-5"
                  />
            ...
            <p className="little-header">
              {t("step-money-result-1")}
              <br />
              {t("step-money-result-2")}
            </p>
            <div className="button rounded">
              <AppLink href="/get_money">
                <button className="takebtn">{t("get-money")}</button>
              </AppLink>
            </div>
            <h2 className="whyus">
              {t("why-title")}
              <span className="whyus--little d-block">{t("why-content")}</span>
            </h2>
        ...
        <section
          ...
          styles={{ backgroundImage: `url(${bottomBanner})` }}
        >
          <div className="container">
            <div className="bContent mb-5">
              ...
              <p className="bContent--text">{t("bContent--text")}</p>
