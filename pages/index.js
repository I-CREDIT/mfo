  ...
  return (
        ...
        <div className="bottom-banner--text ">
          <p className="container">
            Срочно нужны деньги и не у кого одолжить, вы попали в ситуацию потребности средств здесь и прямо сейчас. Предоставляем вашему вниманию сервис получения микрокредитов онлайн не выходя из дома. Быстрое предоставление решения кредитования за 10 минут для физических лиц мужского пола от 21 до 67 лет, для женщин от 21 до 73 лет.<br></br><br></br>
            ...
            В случае нарушения установленного срока платежа по займу, заемщик будет обязан оплатить неустойку, в размере 0,5% от суммы основного долга за каждый день просрочки, но не более 10% от суммы основного долга в год.
          </p>
        </div>
